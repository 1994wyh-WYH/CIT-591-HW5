 ...
 *
 */
public class TopQuotesB {
	private String fileName;
	private ArrayList<String> wholeBook;
	...
	public String[] topQuotes() {
		...
		ArrayList<String> sTemp=getDoubleQuotes();
		sTemp.addAll(getSingleQuotes());
	 ...
	 */
	public ArrayList<String> getDoubleQuotes(){
	 ...
	 */
	public ArrayList<String> getSingleQuotes(){
		long sCreate=System.nanoTime();
		ArrayList<String> ret=new ArrayList<>();
		long eCreate=System.nanoTime();
		tCreate=(eCreate-sCreate);
